...
!(function ($) {
  ...
  function n(t, n) {
    ...
    return (
      ...
      n.precision > 0 && ((i = s.slice(s.length - n.precision)), (o = new Array(n.precision + 1 - i.length).join(0)), (a += n.decimal + o + i)),
      e(a, n)
    )
  }
  function a(t, n) {
        ...
        return (
          ...
          this.each(function () {
                    ...
                    n.compareEndPoints('StartToEnd', r) > -1
                      ...
                      : ((o = -n.moveStart('character', -a)),
                        ...
                        n.compareEndPoints('EndToEnd', r) > -1
                          ? (l = a)
                          : ((l = -n.moveEnd('character', -a)), (l += e.slice(0, l).split('\n').length - 1)))),
                { start: o, end: l }
              )
            }
            function r() {
            ...
            function u(e) {
              ...
              return (
                void 0 !== t &&
                (!(t < 48 || t > 57) || (t === n && w.reverse) ? !!r() && (t !== n || !d()) && (!!w.formatOnBlur || (c(e), p(e), !1)) : g(t, e))
              )
            }
            function d() {
              return !v() && f()
            ...
            function g(e, t) {
              return 45 === e
                ...
                : 13 === e || 9 === e || !(!$.browser.mozilla || (37 !== e && 39 !== e) || 0 !== t.charCode) || (c(t), !0)
            }
            function m() {
              setTimeout(function () {
                l()
            ...
            ;(w = $.extend({}, n)),
                  ...
                  (8 !== s && 46 !== s && 63272 !== s) ||
                    ...
                    n === r &&
                      (8 === s
                        ? '' === w.suffix
                          ? (n -= 1)
                          : ((l = i.split('').reverse().join('').search(/\d/)), (r = 1 + (n = i.length - l - 1)))
                        : (r += 1)),
              ...
              x.bind('focus.maskMoney', function () {
                ...
                w.selectAllOnFocus
                  ? t.select()
                  : t.createTextRange && w.bringCaretAtEndOnFocus && ((e = t.createTextRange()).collapse(!1), e.select())
              }),
              x.bind('click.maskMoney', function () {
                var e,
                  t = x.get(0)
                w.selectAllOnFocus ||
                  (t.setSelectionRange && w.bringCaretAtEndOnFocus ? ((e = x.val().length), t.setSelectionRange(e, e)) : x.val(x.val()))
              }),
              x.bind('dblclick.maskMoney', function () {
                ...
                n.setSelectionRange && w.bringCaretAtEndOnFocus
                  ? ((t = x.val().length), (e = w.doubleClickSelection ? 0 : t), n.setSelectionRange(e, t))
                  : x.val(x.val())
              }),
