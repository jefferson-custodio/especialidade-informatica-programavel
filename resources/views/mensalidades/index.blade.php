...
<div class="adm-page">
  <div class="container">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <a class="btn btn-outline-success my-2 my-sm-0 ml-auto" href="/mensalidades/novo"> Novo </a>
    </nav>
    <table class="table table-striped mt-3">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{{ $item->desbravador->nome }}</td>
          <td>{{ $item->valor }}</td>
          <td>{{ $item->data }}</td>
          <td>
            <a href="/mensalidades/{{$item->id}}/editar" class="edit" title="editar">
